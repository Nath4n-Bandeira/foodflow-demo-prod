module.exports = [
"[project]/src/app/utils/api.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Login() {
    ...
    async function verificaLogin(data) {
        try {
            const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiUrl"])("/clientes/login"), {
                headers: {
            ...
            if (response.status === 200) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(erro?.erro || "Erro... Login ou senha incorretos", {
                    style: {
                        background: "#dc2626",
                        color: "#ffffff"
                    }
...
//# sourceMappingURL=src_app_1bb1c1ea._.js.map