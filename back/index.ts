...
import productRecognitionRouter from "./routes/productRecognition"
import notaFiscalRouter from "./routes/notaFiscal"
...
app.use("/productRecognition", productRecognitionRouter)
app.use("/notasFiscais", notaFiscalRouter)
